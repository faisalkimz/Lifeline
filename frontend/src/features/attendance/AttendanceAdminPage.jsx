...
const AttendanceAdminPage = () => {
    ...
    return (
        <div className="space-y-8 pb-12">
            <div>
                <h1 className="text-3xl font-bold text-gray-900 tracking-tight text-primary-600">Attendance Configuration</h1>
                <p className="text-gray-500 mt-2">Manage geofencing, QR codes, and office locations.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <Card className="rounded-3xl border-none shadow-xl border border-slate-100 overflow-hidden">
                        <CardHeader className="bg-gray-50 border-b border-slate-100 p-6">
                        ...
                        <CardContent className="p-6 space-y-6">
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-slate-100">
                                <div className="flex items-center gap-3">
                                    <div className="p-2 bg-blue-100 text-blue-600 rounded-lg">
                                        <Globe className="h-5 w-5" />
                                    </div>
                                    <div>
                                        <p className="text-sm font-bold text-gray-900">Geofencing</p>
                                        <p className="text-xs text-gray-500">Require GPS coords</p>
                                    </div>
                                </div>
                                <input
                                    type="checkbox"
                            ...
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-slate-100">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-bold text-gray-900">QR Clock-In</p>
                                        <p className="text-xs text-gray-500">Require QR scan</p>
                                    </div>
                                </div>
                                <input
                                    type="checkbox"
                            ...
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-slate-100">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-bold text-gray-900">Photo Verification</p>
                                        <p className="text-xs text-gray-500">Biometric selfie</p>
                                    </div>
                                </div>
                                <input
                                    type="checkbox"
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="rounded-3xl border-none shadow-xl border border-slate-100 overflow-hidden">
                        <CardHeader className="bg-gray-50 border-b border-slate-100 p-6 flex flex-row items-center justify-between">
                            <CardTitle className="text-lg flex items-center gap-2">
                                <MapPin className="h-5 w-5 text-primary-500" />
                                Work Locations
                            </CardTitle>
                            <Button size="sm" onClick={() => setIsAddingMode(true)} className="gap-2 bg-primary-500 hover:bg-primary-600 text-white rounded-xl h-10">
                        ...
                        <CardContent className="p-6">
                            {isAddingMode && (
                                <form onSubmit={handleAddLocation} className="mb-8 p-6 bg-gray-50 rounded-2xl border border-gray-200 animate-in slide-in-from-top duration-300">
                                    <div className="grid grid-cols-2 gap-4 mb-4">
                                        <div className="col-span-2">
                                            <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Location Name</label>
                                            <input
                                                type="text" required
                                                className="w-full h-11 px-4 bg-white rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500/20 outline-none"
                                        ...
                                        <div>
                                            <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Latitude</label>
                                            <input
                                        ...
                                        <div>
                                            <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Longitude</label>
                                            <input
                                                type="number" step="any" required
                                                className="w-full h-11 px-4 bg-white rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500/20 outline-none"
                                                placeholder="32.5825"
                                        ...
                                        <div>
                                            <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Radius (Meters)</label>
                                            <input
                                    ...
                                    <div className="flex justify-end gap-3">
                                        ...
                                        <Button type="submit" className="bg-primary-600" disabled={isAddingLoc}>
                            ...
                            <div className="space-y-4">
                                    ...
                                    <div key={loc.id} className="flex items-center justify-between p-5 bg-white border border-slate-100 rounded-3xl hover:border-emerald-200 transition-all shadow-sm">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="text-right mr-4">
                                                <p className="text-[10px] font-bold text-gray-400 uppercase">QR Token</p>
                                                <p className="text-xs font-mono text-gray-600">{loc.qr_token.substring(0, 8)}...</p>
                                            </div>
                                ...
                                {locations.length === 0 && (
                                    <div className="text-center py-20 border-2 border-dashed border-slate-100 rounded-3xl">
                                        ...
                                        <p className="text-sm text-gray-400 font-medium">No locations configured yet.</p>
                                    </div>
                                )}
                            </div>
                        </CardContent>
